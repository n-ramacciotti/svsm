...
.PHONY: test miri clean clippy bin/bldr.bin bin/svsm-kernel.elf stage1_elf_trampoline distclean $(APROXYBIN) $(IGVM_FILES) $(IGVM_TEST_FILES) $(TEST_IN_SVSM_TARGETS)
