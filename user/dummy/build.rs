...
fn main() {
    ...
    // Userdummy_test
    println!("cargo::rustc-link-arg-bin=userdummy=-Tuser/lib/module.lds");
    println!("cargo::rustc-link-arg-bin=userdummy=-no-pie");
    println!("cargo::rustc-link-arg-bin=userdummy=-nostdlib");
